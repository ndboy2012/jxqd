package com.antox.validatecode;
...
public class RandCodeImageServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -1257947018545327308L; // 要统一常量
	
	public static final String SESSION_KEY_DSCHOOL_REGISTER = "member_style_ds";
	
	public static String randCodeType="3";
	
	public static int randCodeLength=4;
	/**
	 * Session角色
	 */
	...
	public void doGet(final HttpServletRequest request,
			...
			IOException {
		sessionRole = (String) request.getParameter("sessionRole");
		// 设置页面不缓存
		...
		for (int i = 0; i < resultCode.length(); i++) {
			...
			// graphics.setColor(new Color(20 + random.nextInt(130), 20
			// +random.nextInt(130), 20 + random.nextInt(130)));
		...
		request.getSession().setAttribute(sessionRole, resultCode);
